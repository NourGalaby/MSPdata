...
$row='V';
		...
		for ($i=2; ; $i++) { 
			if (empty($data[$i][$row])) {
				...
				trim($data[$i][$row]);
				if(strcmp($data[$i][$row], "Basic") ==0 ){
					
					$English[0]++;
				}
				elseif ( stristr ($data[$i][$row], "Intermediate") ==0 ) {
					$English[1]++;
				}
				elseif (stristr ($data[$i][$row], "Advanced")==0 ) {
					$English[2]++;
				}
				else {
...
$N_English=array("Basic","Intermediate","Advanced","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","");
...
fwrite($file,"\r\n".$N_typeOfApplicant[$i].","."".",".$N_Sex[$i].",".$Sex_type[$i].",".$N_Specialization[$i].","."".",".$N_Degree[$i].",".$Degree[$i].",".$N_Hear[$i].","."".",".$N_English[$i].",".$English[$i].",".$N_age[$i].",".$age_of_appls[$i].",".$IN_ExpectGradDate[$i].",".$gradtion[$i].",".$N_City[$i].",".$city[$i].",".$N_Univeisty[$i].",".$universities[$i].",".$N_Faculty[$i].",".$facluty[$i]);
}
fclose($file);
